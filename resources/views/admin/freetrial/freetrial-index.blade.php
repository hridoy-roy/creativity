...
@section ('page-title', 'free-trial || list')
@push ('page-css')
<style>
</style>
@endpush
...
<div class="app-title">
  <div>
    <h1><i class="fas fa-adjust"></i></i>Free Trials</h1>
  </div>
  <ul class="app-breadcrumb breadcrumb">
    <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
    <li class="breadcrumb-item"><a href="#">Free Trial Lists</a></li>
  </ul>
</div>
<div class="row">
  <div class="col-md-12">
            ...
            <tbody>
              @foreach ($datas as $key=>$data)
                  <tr>
                      ...
                      <td class="d-flex">
                          <a class="btn btn-info btn-sm" href="{{ route('admin.freetrial.show', $data->id) }}"><i class="fa fa-eye"></i></a>
                          <button onclick="deleteCategory({{ $data->id }})" type="button" class="btn btn-danger btn-sm waves-effect">
                            </i><i class="fa fa-trash"></i>
                        </button>
                        <form id="delete-form-{{ $data->id }}"
                            style="dispaly:none"
                              action="{{ route('admin.freetrial.destroy',$data->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
                        </form>
                      </td>
