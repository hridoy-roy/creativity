<section class="why-designer-country">
    <div class="container py-col-2 py-sm-3 py-md-4 py-lg-5 py-xl-5 mobile-pt">
        ...
        <div class="row">
            <div class="col-md-6 col-lg-4">
                <div class="quality">
                    <div class="title text-center pb-col-2 pb-sm-2 pb-md-3 pb-lg-4 pb-xl-4 mobile-py-10 ">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="price">
                    <div class="text-center pb-col-2 pb-sm-2 pb-md-3 pb-lg-4 pb-xl-4 mobile-py-10 ">
